            ...
            <div class="streaming__features-top">
                <div class="streaming__features-top-title">
                    <div data-aos="fade-up">
                        <h3>{{ $t('welcome.advantages.title') }}</h3>
                    </div>
...
.dark-mode .streaming__features {
    ...
    .streaming__features-top {
        ...
        .streaming__features-top-title {
            @apply text-center w-full text-white transition-colors;
    ...
    .streaming__features-content {
        @apply grid lg:grid-cols-2 xl:grid-cols-3 gap-7;
            ...
            .streaming__features-card-inner {
                ...
                .streaming__features-card-icon-name {
                    ...
                    .streaming__features-card-icon {
                        @apply text-4xl text-vlada-color-quinary bg-vlada-color-primary p-3 flex rounded-lg border-2 border-vlada-color-tertiary mr-3;
                    }
                }
...
.light-mode .streaming__features {
    @apply bg-vlada-color-primary-light;
    ...
    .streaming__features-content {
        ...
        .streaming__features-card {
            ...
            .streaming__features-card-inner {
                @apply h-full bg-vlada-color-primary-light rounded-2xl p-8 relative overflow-hidden border-2 border-vlada-color-septenary border-opacity-5 transition-colors;
                ...
                .streaming__features-card-icon-name {
                    ...
                    .streaming__features-card-icon {
                        @apply text-4xl text-vlada-color-quinary bg-vlada-color-primary-light p-3 flex rounded-lg border-2 border-vlada-color-tertiary border-opacity-5 mr-3;
                    }
                }

                .streaming__features-card-description {
                    @apply my-2 text-black font-light;
                }
            }
        }
    }
