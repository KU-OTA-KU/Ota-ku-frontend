import { d as makeLazyProps, e as useLazy, m as makeVOverlayProps, V as VDialogTransition, u as useScopeId, b as VOverlay, f as forwardRefs, _ as __nuxt_component_0 } from "./VOverlay-BfcxL7a6.js";
import { defineComponent, ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, mergeProps, Fragment, inject, vShow, nextTick, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, renderList, useSSRContext, resolveComponent, toRef } from "vue";
import axios from "axios";
import { Storage } from "@capacitor/storage";
import { c as cleanDescription, ah as openAnime, m as makeComponentProps, a as makeTagProps, E as useGroup, W as VBtn, u as useRender, V as VDefaultsProvider, ai as VProgressLinear, F as makeGroupItemProps, I as useGroupItem, b as useSsrBoot, M as MaybeTransition, aj as makeVImgProps, Y as VImg, a0 as VContainer, X as VSkeletonLoader, Q as VCard, S as VCardTitle, T as VCardSubtitle, Z as VCardText, ak as VCardActions, y as VIcon, U as VRow, a5 as VCol, f as makeBorderProps, i as makeElevationProps, a1 as makeLayoutItemProps, j as makeRoundedProps, A as useBackgroundColor, p as useBorder, t as useElevation, v as useRounded, P as useResizeObserver, a2 as useLayoutItem, _ as VLayout, $ as VMain } from "./VMain-DifQI0dA.js";
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderStyle } from "vue/server-renderer";
import { ac as keys, p as propsFactory, m as makeThemeProps, g as genericComponent, k as provideTheme, F as useRtl, A as useLocale, I as IconValue, d as useProxiedModel, o as convertToUnit, _ as _export_sfc } from "../server.mjs";
              ...
              _push3(ssrRenderComponent(VContainer, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(`</li></ul></div><div class="text-no-wrap"${_scopeId3}><h3${_scopeId3}>Контакты</h3><ul style="${ssrRenderStyle({ "list-style": "none", "font-size": "0.9em" })}"${_scopeId3}><li class="mb-1"${_scopeId3}>Email: <span${_scopeId3}>w33bv.gl@gmail.com</span></li><li class="mb-1"${_scopeId3}>Телефон: <span${_scopeId3}>+374(94)161-331</span></li></ul></div></div></div><div class="d-flex ga-3" style="${ssrRenderStyle({ "font-size": "0.9em" })}"${_scopeId3}><span${_scopeId3}>© 2023 - 2024 オタ-KU OTA-KU Все права защищены. Сайт</span><a href="https://ota-ku.ru/"${_scopeId3}>Ota-ku.ru</a></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", {
                        ...
                        createVNode("span", null, "© 2023 - 2024 オタ-KU OTA-KU Все права защищены. Сайт"),
...
//# sourceMappingURL=index-CUqWMH7z.js.map
