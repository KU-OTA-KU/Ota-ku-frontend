import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, ref, provide, createElementBlock, watch, onScopeDispose, Fragment, computed, watchEffect, toRefs, capitalize, readonly, isVNode, Comment, warn, camelize, createVNode, mergeProps, nextTick, Suspense, Transition, withCtx, useSSRContext, Text, resolveDynamicComponent, withDirectives, TransitionGroup, resolveDirective, vShow, createTextVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    name: "catalog",
    path: "/catalog",
    component: () => import("./_nuxt/catalog-B4yEGrRE.js").then((m) => m.default || m)
  },
  {
    name: "doc-authors_ru",
    path: "/doc/authors_ru",
    component: () => import("./_nuxt/authors_ru-CAsVCjA5.js").then((m) => m.default || m)
  },
  {
    name: "doc-privacy_policy_ru",
    path: "/doc/privacy_policy_ru",
    component: () => import("./_nuxt/privacy_policy_ru-Cg8Onpvf.js").then((m) => m.default || m)
  },
  {
    name: "doc-terms_ru",
    path: "/doc/terms_ru",
    component: () => import("./_nuxt/terms_ru-iFzXzBtS.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-qZZnlo5r.js").then((m) => m.default || m)
  },
  {
    name: "OpenAnimeView",
    path: "/OpenAnimeView",
    component: () => import("./_nuxt/OpenAnimeView-BLSyQ2YN.js").then((m) => m.default || m)
  },
  {
    name: "releases",
    path: "/releases",
    component: () => import("./_nuxt/releases-Hy04EEsB.js").then((m) => m.default || m)
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import("./_nuxt/schedule-DJLfwyPq.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-DJJjD-C-.js").then((m) => m.default || m)
};
...
export {
  ...
  matchesSelector as T,
  useLocale as U,
  VDefaultsProvider as V,
  makeTransitionProps as W,
  ...
  useRender as a,
  useGroup as a0,
  makeGroupItemProps as a1,
  makeSizeProps as a2,
  useSize as a3,
  useGroupItem as a4,
  isClickInsideElement as a5,
  focusableChildren as a6,
  getNextElement as a7,
  makeLoaderProps as a8,
  useLoader as a9,
  flipSide as aA,
  flipAlign as aB,
  flipCorner as aC,
  ...
  useLayout as aK,
  injectHead as aL,
  resolveUnrefHeadInput as aM,
  makeDisplayProps as aN,
  useGoTo as aO,
  keys as aP,
  VProgressLinear as aQ,
  makeVImgProps as aR,
  VCardActions as aS,
  useIntersectionObserver as aT,
  __nuxt_component_0 as aU,
  LoaderSlot as aa,
  isOn as ab,
  pick as ac,
  Intersect as ad,
  ...
  useLayoutItem as aw,
  VBtnToggleSymbol as ax,
  destructComputed as ay,
  parseAnchor as az,
