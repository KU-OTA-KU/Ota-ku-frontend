import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, Fragment, computed, watchEffect, toRefs, capitalize, isVNode, Comment, warn, ref, provide, defineComponent as defineComponent$1, camelize, createVNode, mergeProps, readonly, defineAsyncComponent, Suspense, nextTick, Transition, useSSRContext, Text, resolveDynamicComponent, withDirectives, TransitionGroup, resolveDirective, vShow, withCtx, createTextVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$2 } from "vue-router";
...
const _routes = [
  {
    name: "catalog",
    path: "/catalog",
    component: () => import("./_nuxt/catalog-BLZYZWTO.js")
  },
  {
    name: "doc-authors_ru",
    path: "/doc/authors_ru",
    component: () => import("./_nuxt/authors_ru-DjC5e7FH.js")
  },
  {
    name: "doc-privacy_policy_ru",
    path: "/doc/privacy_policy_ru",
    component: () => import("./_nuxt/privacy_policy_ru-mwUW8kV3.js")
  },
  {
    name: "doc-terms_ru",
    path: "/doc/terms_ru",
    component: () => import("./_nuxt/terms_ru-A5dMVuwC.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D-M-Sw9d.js")
  },
  {
    name: "OpenAnimeView",
    path: "/OpenAnimeView",
    component: () => import("./_nuxt/OpenAnimeView-C7ENDwJh.js")
  },
  {
    name: "releases",
    path: "/releases",
    component: () => import("./_nuxt/releases-DXZWBRo7.js")
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import("./_nuxt/schedule-CvGqEA40.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Bah_Gd2O.js").then((m) => m.default || m))
};
...
const _imports_0 = publicAssetsURL("/person/darkness_1.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(ssrRenderComponent(VLayout, mergeProps({ height: "100vh" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VContainer, { class: "d-flex ga-5 justify-center align-lg-center align-md-center pa-2" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(VCard, { variant: "text" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(VCardTitle, {
                      class: "text-center pa-0",
                      style: { "font-size": "10em", "width": "100%" }
                    }, {
                    ...
                    _push4(ssrRenderComponent(VCardSubtitle, {
                      class: "text-center pa-0",
                      style: { "font-size": "2em" }
                    }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`Упс, кажется, вы потерялись!`);
                        } else {
                          return [
                            createTextVNode("Упс, кажется, вы потерялись!")
                          ];
                        }
                      }),
                      _: 1
                    }, _parent4, _scopeId3));
                    _push4(ssrRenderComponent(VCardActions, { class: "page-404-info pa-0" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(VBtn, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                ...
                                return [
                                  createTextVNode(" В главную ")
                                ];
                              }
                            }),
                            _: 1
                          }, _parent5, _scopeId4));
                          _push5(ssrRenderComponent(VBtn, { icon: "mdi-home" }, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`wв`);
                              } else {
                          ...
                          return [
                            ...
                            createVNode(VBtn, { icon: "mdi-home" }, {
                              default: withCtx(() => [
                                createTextVNode("wв")
                              ]),
                              _: 1
                    ...
                    return [
                      ...
                      createVNode(VCardActions, { class: "page-404-info pa-0" }, {
                        default: withCtx(() => [
                          createVNode(VBtn, {
                            "prepend-icon": "mdi-home",
                            variant: "flat",
              ...
              _push3(`<div class="image-container-404" data-v-a502d59c${_scopeId2}>`);
              _push3(ssrRenderComponent(VImg, {
                width: "400px",
                src: _imports_0,
                "lazy-src": _imports_0,
                alt: "Коносуба Даркнесс"
              ...
              return [
                ...
                createVNode("div", { class: "image-container-404" }, [
                  createVNode(VImg, {
                    width: "400px",
                    src: _imports_0,
                    "lazy-src": _imports_0,
        ...
        return [
          createVNode(VContainer, { class: "d-flex ga-5 justify-center align-lg-center align-md-center pa-2" }, {
            default: withCtx(() => [
              createVNode(VCard, { variant: "text" }, {
                default: withCtx(() => [
                  createVNode(VCardTitle, {
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a502d59c"]]);
const _sfc_main = {
  __name: "nuxt-root",
...
export {
  ...
  getPropertyFromItem as N,
  omit as O,
  useBackgroundColor as P,
  provideDefaults as Q,
  Ripple as R,
  focusChild as S,
  filterInputAttrs as T,
  matchesSelector as U,
  VDefaultsProvider as V,
  useLocale as W,
  makeTransitionProps as X,
  getCurrentInstanceName as Y,
  useToggleScope as Z,
  only as _,
  useRender as a,
  wrapInKeepAlive as a$,
  makeGroupProps as a0,
  useGroup as a1,
  makeGroupItemProps as a2,
  makeSizeProps as a3,
  useSize as a4,
  useGroupItem as a5,
  isClickInsideElement as a6,
  getNextElement as a7,
  focusableChildren as a8,
  makeLoaderProps as a9,
  ...
  useGoTo as aK,
  keys as aL,
  VProgressLinear as aM,
  makeVImgProps as aN,
  VCardActions as aO,
  useIntersectionObserver as aP,
  makeLayoutItemProps as aQ,
  useLayoutItem as aR,
  useTheme as aS,
  VBtnToggleSymbol as aT,
  PageRouteSymbol as aU,
  useNuxtApp as aV,
  LayoutMetaSymbol as aW,
  generateRouteKey$1 as aX,
  appPageTransition as aY,
  appKeepalive as aZ,
  _wrapIf as a_,
  useLoader as aa,
  LoaderSlot as ab,
  ...
  isObject as aj,
  debounce as ak,
  ensureValidVNode as al,
  checkPrintable as am,
  _export_sfc as an,
  VCard as ao,
  VCardTitle as ap,
  VCardSubtitle as aq,
