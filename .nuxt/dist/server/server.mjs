...
const _routes = [
  {
    name: "catalog",
    path: "/catalog",
    component: () => import("./_nuxt/catalog-BeVD1OQg.js").then((m) => m.default || m)
  },
  {
    name: "doc-authors_ru",
    path: "/doc/authors_ru",
    component: () => import("./_nuxt/authors_ru-Bd3GupBs.js").then((m) => m.default || m)
  },
  {
    name: "doc-privacy_policy_ru",
    path: "/doc/privacy_policy_ru",
    component: () => import("./_nuxt/privacy_policy_ru-alhpnJZ7.js").then((m) => m.default || m)
  },
  {
    name: "doc-terms_ru",
    path: "/doc/terms_ru",
    component: () => import("./_nuxt/terms_ru-K9TCLI1y.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CUqWMH7z.js").then((m) => m.default || m)
  },
  {
    name: "OpenAnimeView",
    path: "/OpenAnimeView",
    component: () => import("./_nuxt/OpenAnimeView-wU1INFQK.js").then((m) => m.default || m)
  },
  {
    name: "releases",
    path: "/releases",
    component: () => import("./_nuxt/releases-Dkmbeya0.js").then((m) => m.default || m)
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import("./_nuxt/schedule-XxpPbCpl.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-IblgyrKf.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dkt4eV7j.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cf0JcvXr.js").then((r) => r.default || r));
...
export {
  ...
  EventProp as E,
  useRtl as F,
  isClickInsideElement as G,
  focusableChildren as H,
  IconValue as I,
  getNextElement as J,
  isOn as K,
  pick as L,
  ...
  clamp as O,
  debounce as P,
  ensureValidVNode as Q,
  eventName as R,
  useTheme as S,
  destructComputed as T,
  consoleError as U,
  defer as V,
  templateRef as W,
  IN_BROWSER as X,
  ...
  navigateTo as a,
  isCssColor as a0,
  isParsableColor as a1,
  parseColor as a2,
  getForeground as a3,
  useIcon as a4,
  flattenFragments as a5,
  hasEvent as a6,
  isObject as a7,
  keyCodes as a8,
  breakpoints as a9,
  makeDisplayProps as aa,
  useGoTo as ab,
  keys as ac,
  __nuxt_component_0 as ad,
  ...
  getPropertyFromItem as s,
  omit as t,
  useRouter as u,
  provideDefaults as v,
  wrapInArray as w,
  focusChild as x,
  filterInputAttrs as y,
  matchesSelector as z
};
