import { version as version$1, unref, inject as inject$1, defineComponent as defineComponent$1, ref, provide, createElementBlock, watch, onScopeDispose, Fragment, reactive, computed, watchEffect, toRefs, capitalize, isVNode, Comment, shallowRef, readonly, warn, getCurrentInstance as getCurrentInstance$1, toRaw, createVNode, mergeProps, h, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, effectScope, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, defineAsyncComponent, isReadonly, withCtx, isRef, isShallow, isReactive } from 'file://Z:/Ota-ku-nuxt/node_modules/vue/index.mjs';
...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://Z:/Ota-ku-nuxt/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://Z:/Ota-ku-nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://Z:/Ota-ku-nuxt/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://Z:/Ota-ku-nuxt/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://Z:/Ota-ku-nuxt/node_modules/ufo/dist/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "doc-authors_ru",
    path: "/doc/authors_ru",
    component: () => import('./authors_ru-Bd3GupBs.mjs').then((m) => m.default || m)
  },
  {
    name: "doc-privacy_policy_ru",
    path: "/doc/privacy_policy_ru",
    component: () => import('./privacy_policy_ru-alhpnJZ7.mjs').then((m) => m.default || m)
  },
  {
    name: "doc-terms_ru",
    path: "/doc/terms_ru",
    component: () => import('./terms_ru-K9TCLI1y.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "releases",
    path: "/releases",
    component: () => import('./releases-Dkmbeya0.mjs').then((m) => m.default || m)
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import('./schedule-XxpPbCpl.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-IblgyrKf.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dkt4eV7j.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Cf0JcvXr.mjs').then((r) => r.default || r));
...
export { findChildrenWithProvide as $, useLocale as A, getCurrentInstanceName as B, useToggleScope as C, only as D, EventProp as E, useRtl as F, isClickInsideElement as G, focusableChildren as H, IconValue as I, getNextElement as J, isOn as K, pick as L, callEvent as M, useDisplay as N, clamp as O, debounce as P, ensureValidVNode as Q, eventName as R, useTheme as S, destructComputed as T, consoleError as U, defer as V, templateRef as W, IN_BROWSER as X, includes as Y, eagerComputed as Z, _export_sfc as _, navigateTo as a, isCssColor as a0, isParsableColor as a1, parseColor as a2, getForeground as a3, useIcon as a4, flattenFragments as a5, hasEvent as a6, isObject as a7, keyCodes as a8, breakpoints as a9, makeDisplayProps as aa, useGoTo as ab, keys as ac, __nuxt_component_0 as ad, useRuntimeConfig as b, resolveUnrefHeadInput as c, useProxiedModel as d, entry$1 as default, consoleWarn as e, getCurrentInstance as f, genericComponent as g, getUid as h, injectHead as i, defineComponent as j, provideTheme as k, deprecate as l, makeThemeProps as m, nuxtLinkDefaults as n, convertToUnit as o, propsFactory as p, deepEqual as q, resolveRouteObject as r, getPropertyFromItem as s, omit as t, useRouter as u, provideDefaults as v, wrapInArray as w, focusChild as x, filterInputAttrs as y, matchesSelector as z };
