import { d as makeLazyProps, e as useLazy, m as makeVOverlayProps, V as VDialogTransition, u as useScopeId, b as VOverlay, f as forwardRefs, _ as __nuxt_component_0 } from './VOverlay-tSqOqrjm.mjs';
import { defineComponent, ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, mergeProps, Fragment, inject, vShow, useSSRContext, nextTick, toRef, withCtx, openBlock, createBlock, toDisplayString, createCommentVNode, renderList, createTextVNode, resolveComponent } from 'file://Z:/Ota-ku-nuxt/node_modules/vue/index.mjs';
...
import { d as cleanDescription, g as openAnime, u as useSsrBoot, c as VMain, f as VSkeletonLoader, e as VRow, h as VCol } from './VMain-5HMtes9m.mjs';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderAttr } from 'file://Z:/Ota-ku-nuxt/node_modules/vue/server-renderer/index.mjs';
import { p as propsFactory, m as makeComponentProps, f as makeTagProps, q as makeThemeProps, g as genericComponent, t as provideTheme, _ as useRtl, U as useLocale, a0 as useGroup, ao as VBtn, a as useRender, I as IconValue, u as useProxiedModel, J as convertToUnit, V as VDefaultsProvider, aQ as VProgressLinear, a1 as makeGroupItemProps, a4 as useGroupItem, M as MaybeTransition, aR as makeVImgProps, ap as VImg, i as makeBorderProps, l as makeElevationProps, av as makeLayoutItemProps, n as makeRoundedProps, O as useBackgroundColor, v as useBorder, A as useElevation, B as useRounded, af as useResizeObserver, aw as useLayoutItem, ak as _export_sfc, ar as VLayout, aP as keys, al as VCard, am as VCardTitle, an as VCardSubtitle, aS as VCardActions, as as VContainer, G as VIcon } from './server.mjs';
              ...
              _push3(ssrRenderComponent(VContainer, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(`</li></ul></div><div class="text-no-wrap"${_scopeId3}><h3${_scopeId3}>\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u044B</h3><ul style="${ssrRenderStyle({ "list-style": "none", "font-size": "0.9em" })}"${_scopeId3}><li class="mb-1"${_scopeId3}>Email: <span${_scopeId3}>w33bv.gl@gmail.com</span></li><li class="mb-1"${_scopeId3}>\u0422\u0435\u043B\u0435\u0444\u043E\u043D: <span${_scopeId3}>+374(94)161-331</span></li></ul></div></div></div><div class="d-flex mb-7" style="${ssrRenderStyle({ "font-size": "0.9em" })}"${_scopeId3}><span${_scopeId3}>\xA92023-2024 OTA-KU \u0412\u0441\u0435 \u043F\u0440\u0430\u0432\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043D\u044B.</span></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", {
                        ...
                        createVNode("span", null, "\xA92023-2024 OTA-KU \u0412\u0441\u0435 \u043F\u0440\u0430\u0432\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043D\u044B.")
                      ])
                    ];
                  }
                }),
...
//# sourceMappingURL=index-yHzvb4EK.mjs.map
