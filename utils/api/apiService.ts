...
interface ApiServiceInterface {
    ...
    post(url: string, data?: any, headers?: Record<string, string>): Promise<AxiosResponse<any>>;
    delete(url: string, headers?: Record<string, string>): Promise<AxiosResponse<any>>;
}
